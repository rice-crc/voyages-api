		...
		indices={
			...
			'voyage_maps': {
				'vars':	[
					...
					'voyage_itinerary__imp_principal_port_slave_dis__region__id',
					'voyage_itinerary__imp_principal_port_slave_dis__region__broad_region__id',
					'voyage_itinerary__imp_principal_place_of_slave_purchase__id',
					'voyage_itinerary__imp_principal_place_of_slave_purchase__region__id',
					'voyage_itinerary__imp_principal_place_of_slave_purchase__region__broad_region__id',
					'voyage_ship__imputed_nationality__name',
					'voyage_ship__tonnage_mod',
